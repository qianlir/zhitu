function SchoolsPage({ onOpenSchool, initialQuery, onNavigate }) {
  ...
  }, style: { fontSize: 13, color: "var(--text-3)", textDecoration: "none", marginBottom: 8, display: "inline-block" } }, "\u2190 \u8FD4\u56DE\u9996\u9875"), /* @__PURE__ */ React.createElement("h1", { style: { fontSize: 24, fontWeight: 600, margin: "0 0 16px" } }, "\u5B66\u6821\u67E5\u8BE2"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 12, alignItems: "center" } }, /* @__PURE__ */ React.createElement("input", { type: "search", placeholder: "\u641C\u7D22\u5B66\u6821\u540D\u79F0...", value: query, onChange: (e) => setQuery(e.target.value), style: { flex: 1, fontSize: 15, padding: "12px 16px" } }), /* @__PURE__ */ React.createElement("button", { className: "btn btn-primary", onClick: () => {
