...
// frontend/js/pages/SchoolDetail.jsx
...
var require_SchoolDetail = __commonJS(() => {
  function SchoolDetailPage({ schoolId, onNavigate, onCompare, compareIds = [] }) {
    ...
    if (loading)
      return /* @__PURE__ */ jsxDEV("main", {
        ...
        children: /* @__PURE__ */ jsxDEV(Loading, {}, undefined, false, undefined, this)
      }, undefined, false, undefined, this);
    if (err)
      return /* @__PURE__ */ jsxDEV("main", {
        style: { maxWidth: 1280, margin: "0 auto", padding: "24px 24px 64px" },
        children: /* @__PURE__ */ jsxDEV(ErrorBox, {
          err,
    ...
    return /* @__PURE__ */ jsxDEV("main", {
      ...
      children: [
        ...
        tab === "basic" && /* @__PURE__ */ jsxDEV(BasicTab, {
          school
        }, undefined, false, undefined, this),
        tab === "history" && /* @__PURE__ */ jsxDEV(HistoryTab, {
          school
        }, undefined, false, undefined, this),
        tab === "gaokao" && /* @__PURE__ */ jsxDEV(GaokaoTab, {
          school
        }, undefined, false, undefined, this),
        tab === "eval" && /* @__PURE__ */ jsxDEV(EvalTab, {
          school
        }, undefined, false, undefined, this)
      ]
    }, undefined, true, undefined, this);
          ...
          children: [
            ...
            /* @__PURE__ */ jsxDEV("table", {
              ...
              children: /* @__PURE__ */ jsxDEV("tbody", {
                children: rows.map((r, i) => /* @__PURE__ */ jsxDEV("tr", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxDEV("td", {
                      ...
                      children: r[2] ? /* @__PURE__ */ jsxDEV("a", {
      ...
      children: [
        /* @__PURE__ */ jsxDEV("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxDEV("svg", {
              ...
              children: [
                [0, 0.25, 0.5, 0.75, 1].map((p, i) => /* @__PURE__ */ jsxDEV("line", {
                  x1: P,
                  x2: W - P,
                  y1: P + p * (H - P * 2),
                  y2: P + p * (H - P * 2),
                ...
                [0, 0.5, 1].map((p, i) => /* @__PURE__ */ jsxDEV("text", {
                  x: P - 8,
                  y: P + p * (H - P * 2) + 4,
                  textAnchor: "end",
                  fontSize: "11",
                ...
                data.map((d, i) => /* @__PURE__ */ jsxDEV("g", {
                  children: [
        ...
        /* @__PURE__ */ jsxDEV("div", {
          ...
          children: [
              ...
              children: [
                /* @__PURE__ */ jsxDEV("thead", {
                  ...
                  children: /* @__PURE__ */ jsxDEV("tr", {
                    children: ["年份", "统招最低分", "名额到区", "名额到校", "自招分", "控制线", "较前年"].map((h) => /* @__PURE__ */ jsxDEV("th", {
            ...
            /* @__PURE__ */ jsxDEV("div", {
              style: { padding: "10px 16px", fontSize: 12, color: "var(--text-3)", background: "var(--bg)", borderTop: "1px solid var(--border)" },
              children: "注：名额到区分数为整体最低录取分，各区实际分数线不同。待各区分数据补充后将自动显示分区详情。"
            }, undefined, false, undefined, this)
          ]
        }, undefined, true, undefined, this)
      ]
  ...
  function GaokaoTab({ school }) {
    ...
    return /* @__PURE__ */ jsxDEV("div", {
      ...
      children: metrics.map((m, i) => /* @__PURE__ */ jsxDEV("div", {
        className: "card card-pad",
        children: [
          /* @__PURE__ */ jsxDEV("div", {
        ...
        /* @__PURE__ */ jsxDEV("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxDEV("svg", {
              ...
              style: { width: "100%", height: "auto" },
              children: [
                [0.25, 0.5, 0.75, 1].map((p, i) => /* @__PURE__ */ jsxDEV("polygon", {
                  fill: "none",
                  stroke: "#e5e7eb",
                  strokeWidth: "1",
