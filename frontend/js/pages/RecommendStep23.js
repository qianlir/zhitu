function Step2({ list, picks, toggle, district, nav, allSchools }) {
  return jsxDEV_7x81h0kn("div", {
    children: [
      ...
      picks.length > 0 && jsxDEV_7x81h0kn("div", {
      ...
      jsxDEV_7x81h0kn("div", {
        ...
        children: [
          list.map((s) => jsxDEV_7x81h0kn(PickCard, {
            school: s,
          ...
          list.length === 0 && jsxDEV_7x81h0kn("div", {
...
function Step3({ list, picks, toggle, used, district, score, nav, tdPick, tsPicks, onOpenSchool, allSchools }) {
  ...
  const Section = ({ title, icon, color, schools }) => jsxDEV_7x81h0kn("div", {
    ...
    children: [
      ...
      jsxDEV_7x81h0kn("div", {
        ...
        children: schools.map((s) => jsxDEV_7x81h0kn(PickCard, {
          school: s,
      ...
      schools.length === 0 && jsxDEV_7x81h0kn("div", {
  ...
  const SummaryPanel = () => jsxDEV_7x81h0kn("div", {
    className: "card card-pad",
    ...
    children: [
      ...
      jsxDEV_7x81h0kn("div", {
        ...
        children: tdPick ? getSchool(tdPick)?.name : jsxDEV_7x81h0kn("span", {
      ...
      [0, 1].map((i) => jsxDEV_7x81h0kn("div", {
        style: { fontSize: 13, marginBottom: 4 },
        children: [
          i + 1,
          ". ",
          tsPicks[i] ? getSchool(tsPicks[i])?.name : jsxDEV_7x81h0kn("span", {
            style: { color: "var(--text-muted)" },
            children: "未选"
          }, undefined, false, undefined, this)
        ]
      ...
      picks.filter(Boolean).length === 0 && jsxDEV_7x81h0kn("div", {
      ...
      picks.filter(Boolean).length > 0 && jsxDEV_7x81h0kn("button", {
    ...
    children: [
      ...
      jsxDEV_7x81h0kn("div", {
        ...
        children: [
          ...
          jsxDEV_7x81h0kn(SummaryPanel, {}, undefined, false, undefined, this)
        ]
      }, undefined, true, undefined, this),
      nav
    ]
