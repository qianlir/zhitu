function ComparePage({ initialIds, onOpenSchool, onNavigate }) {
  ...
  return jsxDEV_7x81h0kn("main", {
    ...
    children: [
      ...
      jsxDEV_7x81h0kn("div", {
        ...
        children: [
          jsxDEV_7x81h0kn("div", {
            ...
            children: [
              selected.map((id, idx) => jsxDEV_7x81h0kn("span", {
                className: "pill",
              ...
              selected.length < 5 && jsxDEV_7x81h0kn("span", {
                style: { fontSize: 13, color: "var(--text-3)" },
                children: selected.length === 0 ? "选择 2-5 所学校开始对比 →" : "还可添加 " + (5 - selected.length) + " 所"
              }, undefined, false, undefined, this)
            ]
          }, undefined, true, undefined, this),
          selected.length < 5 && jsxDEV_7x81h0kn("div", {
            ...
            children: [
              ...
              search && candidates.length > 0 && jsxDEV_7x81h0kn("div", {
                className: "card",
                ...
                children: candidates.slice(0, 8).map((c) => jsxDEV_7x81h0kn("button", {
                  onClick: () => add(c.id),
      ...
      selected.length < 2 ? jsxDEV_7x81h0kn("div", {
      ...
      }, undefined, true, undefined, this) : loading ? jsxDEV_7x81h0kn(Loading, {}, undefined, false, undefined, this) : jsxDEV_7x81h0kn("div", {
        className: "card",
        style: { overflow: "auto" },
        children: jsxDEV_7x81h0kn("table", {
          ...
          children: [
            ...
            jsxDEV_7x81h0kn("tbody", {
              children: [
                jsxDEV_7x81h0kn(SectionRow, {
                  label: "基本信息",
                  cols: schools.length + 1
                }, undefined, false, undefined, this),
                jsxDEV_7x81h0kn(CmpRow, {
                  label: "区域",
                  sticky: true,
                  children: schools.map((s) => jsxDEV_7x81h0kn("td", {
                ...
                jsxDEV_7x81h0kn(CmpRow, {
                  ...
                  children: (() => {
                    ...
                    return schools.map((s, i) => jsxDEV_7x81h0kn(Cell, {
                      value: s.intake,
                      mono: true,
                      suffix: " 人",
                      isBest: i === best
                ...
                jsxDEV_7x81h0kn(CmpRow, {
                  label: "2023 统招",
                  sticky: true,
                  children: schools.map((s) => jsxDEV_7x81h0kn(Cell, {
                ...
                jsxDEV_7x81h0kn(CmpRow, {
                  ...
                  children: schools.map((s) => jsxDEV_7x81h0kn("td", {
                    style: { padding: "12px 16px", textAlign: "center" },
                    children: jsxDEV_7x81h0kn(MiniRadar, {
                      school: s
                    }, undefined, false, undefined, this)
                  }, s.id, false, undefined, this))
                }, undefined, false, undefined, this),
      ...
      schools.length >= 2 && jsxDEV_7x81h0kn("div", {
