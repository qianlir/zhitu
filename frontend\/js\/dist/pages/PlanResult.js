...
function PlanResult({ score, district, tdPick, setTdPick, tsPicks, setTsPicks, pPicks, setPPicks, tdList, tsList, pList, onOpenSchool, onBack, allSchools }) {
      ...
      children: /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
            ...
            children: [
              filtered.length === 0 && /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
  ...
  return /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
    children: [
      ...
      pPicks.length < 15 && /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
      ...
      /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
            style: { display: "grid", gap: 8 },
            children: [
              tsPicks.map((id, i) => /* @__PURE__ */ jsxDEV_7x81h0kn(SchoolRow, {
                id,
                i,
                refScoreKey: "dx",
                onRemove: (rid) => setTsPicks(tsPicks.filter((x) => x !== rid))
              }, id, false, undefined, this)),
              tsPicks.length === 0 && /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
                style: { padding: 16, background: "var(--bg)", borderRadius: 8, color: "var(--text-muted)", fontSize: 13, textAlign: "center" },
                children: "未选择"
              }, undefined, false, undefined, this)
            ]
      ...
      /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
            style: { display: "grid", gap: 8 },
            children: [
              pPicks.map((id, i) => /* @__PURE__ */ jsxDEV_7x81h0kn(SchoolRow, {
                id,
                i,
                refScoreKey: "px",
      ...
      /* @__PURE__ */ jsxDEV_7x81h0kn(SearchDropdown, {}, undefined, false, undefined, this)
    ]
  }, undefined, true, undefined, this);
}
