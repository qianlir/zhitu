...
function SchoolsPage({ onOpenSchool, initialQuery, onNavigate }) {
  ...
  const FilterSection = ({ title, children }) => /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
  ...
  const Check = ({ checked, onChange, label }) => /* @__PURE__ */ jsxDEV_7x81h0kn("label", {
  ...
  return /* @__PURE__ */ jsxDEV_7x81h0kn("main", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
        ...
        children: [
          /* @__PURE__ */ jsxDEV_7x81h0kn("aside", {
            className: "card",
            ...
            children: [
              ...
              /* @__PURE__ */ jsxDEV_7x81h0kn(FilterSection, {
                title: "区域",
                children: /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
                  style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 0 },
                  children: districtList.map((d) => /* @__PURE__ */ jsxDEV_7x81h0kn(Check, {
              ...
              /* @__PURE__ */ jsxDEV_7x81h0kn(FilterSection, {
                title: "学校类型",
                children: (typeList.length ? typeList : ["委属市重点", "市实验示范", "区实验示范", "普通高中"]).map((t) => /* @__PURE__ */ jsxDEV_7x81h0kn(Check, {
                  checked: tiers.has(t),
                  onChange: () => toggle(tiers, t, setTiers),
                  label: /* @__PURE__ */ jsxDEV_7x81h0kn("span", {
              ...
              /* @__PURE__ */ jsxDEV_7x81h0kn(FilterSection, {
                title: "办别",
                children: ["公办", "民办"].map((f) => /* @__PURE__ */ jsxDEV_7x81h0kn(Check, {
          ...
          /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
            children: [
              ...
              loading ? /* @__PURE__ */ jsxDEV_7x81h0kn(Loading, {}, undefined, false, undefined, this) : err ? /* @__PURE__ */ jsxDEV_7x81h0kn(ErrorBox, {
                err,
                onRetry: () => location.reload()
              }, undefined, false, undefined, this) : filtered.length === 0 ? /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
              ...
              }, undefined, true, undefined, this) : /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
                style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 },
                children: filtered.map((s) => /* @__PURE__ */ jsxDEV_7x81h0kn(SchoolCard, {
                  school: s,
