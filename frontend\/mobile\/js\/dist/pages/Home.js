  ...
  return /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
        ...
        children: [{ icon: "\uD83D\uDD0D", label: "查学校", r: "schools" }, { icon: "\uD83C\uDFAF", label: "AI填报", r: "recommend" }, { icon: "⚖️", label: "对比", r: "compare" }].map((f) => /* @__PURE__ */ jsxDEV_7x81h0kn("button", {
          className: "mc",
      ...
      featured.length === 0 ? /* @__PURE__ */ jsxDEV_7x81h0kn(MLoading, {}, undefined, false, undefined, this) : featured.map((s) => /* @__PURE__ */ jsxDEV_7x81h0kn(MSchoolRow, {
        school: s,
