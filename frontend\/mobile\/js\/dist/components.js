...
function MTabBar({ tab, setTab }) {
  ...
  return /* @__PURE__ */ jsxDEV_7x81h0kn("nav", {
...
function MNav({ title, subtitle, onBack }) {
  return /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
    ...
    children: [
      onBack && /* @__PURE__ */ jsxDEV_7x81h0kn("button", {
        onClick: onBack,
      ...
      /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
        ...
        children: [
          ...
          subtitle && /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
  ...
  return /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
        ...
        children: [
          school.bbenRate != null && /* @__PURE__ */ jsxDEV_7x81h0kn("span", {
            children: [
              "一本率 ",
          ...
          school.intake != null && /* @__PURE__ */ jsxDEV_7x81h0kn("span", {
            children: [
              "招生 ",
              /* @__PURE__ */ jsxDEV_7x81h0kn("strong", {
                style: { color: "var(--text)" },
...
function MError({ err, onRetry }) {
  return /* @__PURE__ */ jsxDEV_7x81h0kn("div", {
    ...
    children: [
      ...
      onRetry && /* @__PURE__ */ jsxDEV_7x81h0kn("button", {
        className: "mb mb2",
